...
func TestWeightedOperations(t *testing.T) {
	...
	weightedOps := simulation.WeightedOperations(appParams, cdc, app.AccountKeeper, app.BankKeeper, app.LSElysiumKeeper)
	...
	param := app.LSElysiumKeeper.GetParams(ctx)
	...
	app.LSElysiumKeeper.SetParams(ctx, param)
...
func createTestApp(t *testing.T, isCheckTx bool) (*chain.EstakeApp, sdk.Context) {
	app := testhelpers.Setup(t, isCheckTx, 5)

	ctx := app.BaseApp.NewContext(isCheckTx, tmproto.Header{})
	app.MintKeeper.SetParams(ctx, minttypes.DefaultParams())
	app.LSElysiumKeeper.SetParams(ctx, types.DefaultParams())

	return app, ctx
}

func getTestingAccounts(t *testing.T, r *rand.Rand, app *chain.EstakeApp, ctx sdk.Context, n int) []simtypes.Account {
...
func getTestingValidator0(t *testing.T, app *chain.EstakeApp, ctx sdk.Context, accounts []simtypes.Account) stakingtypes.Validator {
...
func getTestingValidator1(t *testing.T, app *chain.EstakeApp, ctx sdk.Context, accounts []simtypes.Account) stakingtypes.Validator {
...
func getTestingValidator(t *testing.T, app *chain.EstakeApp, ctx sdk.Context, accounts []simtypes.Account, commission stakingtypes.Commission, n int) stakingtypes.Validator {
	account := accounts[n]
