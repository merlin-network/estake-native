...
// source: estake/lscosmos/v1beta1/lscosmos.proto
...
type EstakeParams struct {
	EstakeDepositFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=estake_deposit_fee,json=estakeDepositFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_deposit_fee"`
	EstakeRestakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=estake_restake_fee,json=estakeRestakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_restake_fee"`
	EstakeUnstakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=estake_unstake_fee,json=estakeUnstakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_unstake_fee"`
	EstakeRedemptionFee github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=estake_redemption_fee,json=estakeRedemptionFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_redemption_fee"`
	EstakeFeeAddress    string                                 `protobuf:"bytes,5,opt,name=estake_fee_address,json=estakeFeeAddress,proto3" json:"estake_fee_address,omitempty"`
}

func (m *EstakeParams) Reset()         { *m = EstakeParams{} }
func (m *EstakeParams) String() string { return proto.CompactTextString(m) }
func (*EstakeParams) ProtoMessage()    {}
func (*EstakeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dec47e30da12f63, []int{2}
}
func (m *EstakeParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EstakeParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EstakeParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EstakeParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EstakeParams.Merge(m, src)
}
func (m *EstakeParams) XXX_Size() int {
	return m.Size()
}
func (m *EstakeParams) XXX_DiscardUnknown() {
	xxx_messageInfo_EstakeParams.DiscardUnknown(m)
}

var xxx_messageInfo_EstakeParams proto.InternalMessageInfo
...
type HostChainParams struct {
	...
	EstakeParams    EstakeParams                           `protobuf:"bytes,8,opt,name=estake_params,json=estakeParams,proto3" json:"estake_params"`
}
...
func init() {
	proto.RegisterType((*AllowListedValidators)(nil), "estake.lscosmos.v1beta1.AllowListedValidators")
	proto.RegisterType((*AllowListedValidator)(nil), "estake.lscosmos.v1beta1.AllowListedValidator")
	proto.RegisterType((*EstakeParams)(nil), "estake.lscosmos.v1beta1.EstakeParams")
	proto.RegisterType((*HostChainParams)(nil), "estake.lscosmos.v1beta1.HostChainParams")
	proto.RegisterType((*DelegationState)(nil), "estake.lscosmos.v1beta1.DelegationState")
	proto.RegisterType((*HostAccountDelegation)(nil), "estake.lscosmos.v1beta1.HostAccountDelegation")
	proto.RegisterType((*HostAccountUndelegation)(nil), "estake.lscosmos.v1beta1.HostAccountUndelegation")
	proto.RegisterType((*UndelegationEntry)(nil), "estake.lscosmos.v1beta1.UndelegationEntry")
	proto.RegisterType((*HostChainRewardAddress)(nil), "estake.lscosmos.v1beta1.HostChainRewardAddress")
	proto.RegisterType((*IBCAmountTransientStore)(nil), "estake.lscosmos.v1beta1.IBCAmountTransientStore")
	proto.RegisterType((*TransientUndelegationTransfer)(nil), "estake.lscosmos.v1beta1.TransientUndelegationTransfer")
	proto.RegisterType((*UnbondingEpochCValue)(nil), "estake.lscosmos.v1beta1.UnbondingEpochCValue")
	proto.RegisterType((*DelegatorUnbondingEpochEntry)(nil), "estake.lscosmos.v1beta1.DelegatorUnbondingEpochEntry")
	proto.RegisterType((*HostAccounts)(nil), "estake.lscosmos.v1beta1.HostAccounts")
}

func init() {
	proto.RegisterFile("estake/lscosmos/v1beta1/lscosmos.proto", fileDescriptor_4dec47e30da12f63)
}
...
func (this *EstakeParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EstakeParams)
	if !ok {
		that2, ok := that.(EstakeParams)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.EstakeDepositFee.Equal(that1.EstakeDepositFee) {
		return false
	}
	if !this.EstakeRestakeFee.Equal(that1.EstakeRestakeFee) {
		return false
	}
	if !this.EstakeUnstakeFee.Equal(that1.EstakeUnstakeFee) {
		return false
	}
	if !this.EstakeRedemptionFee.Equal(that1.EstakeRedemptionFee) {
		return false
	}
	if this.EstakeFeeAddress != that1.EstakeFeeAddress {
		return false
	}
	return true
}
func (this *HostChainParams) Equal(that interface{}) bool {
	...
	if !this.EstakeParams.Equal(&that1.EstakeParams) {
		return false
	}
	return true
}
...
func (m *EstakeParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EstakeParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EstakeParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EstakeFeeAddress) > 0 {
		i -= len(m.EstakeFeeAddress)
		copy(dAtA[i:], m.EstakeFeeAddress)
		i = encodeVarintLscosmos(dAtA, i, uint64(len(m.EstakeFeeAddress)))
		i--
		dAtA[i] = 0x2a
	}
	{
		size := m.EstakeRedemptionFee.Size()
		i -= size
		if _, err := m.EstakeRedemptionFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLscosmos(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x22
	{
		size := m.EstakeUnstakeFee.Size()
		i -= size
		if _, err := m.EstakeUnstakeFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLscosmos(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x1a
	{
		size := m.EstakeRestakeFee.Size()
		i -= size
		if _, err := m.EstakeRestakeFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLscosmos(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x12
	{
		size := m.EstakeDepositFee.Size()
		i -= size
		if _, err := m.EstakeDepositFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLscosmos(dAtA, i, uint64(size))
	}
...
func (m *HostChainParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.EstakeParams.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EstakeParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.EstakeDepositFee.Size()
	n += 1 + l + sovLscosmos(uint64(l))
	l = m.EstakeRestakeFee.Size()
	n += 1 + l + sovLscosmos(uint64(l))
	l = m.EstakeUnstakeFee.Size()
	n += 1 + l + sovLscosmos(uint64(l))
	l = m.EstakeRedemptionFee.Size()
	n += 1 + l + sovLscosmos(uint64(l))
	l = len(m.EstakeFeeAddress)
	if l > 0 {
		n += 1 + l + sovLscosmos(uint64(l))
	}
	return n
...
func (m *EstakeParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EstakeParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EstakeParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EstakeDepositFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EstakeDepositFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EstakeRestakeFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EstakeRestakeFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EstakeUnstakeFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EstakeUnstakeFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EstakeRedemptionFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EstakeRedemptionFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EstakeFeeAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EstakeFeeAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipLscosmos(dAtA[iNdEx:])
...
func (m *HostChainParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EstakeParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EstakeParams.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
