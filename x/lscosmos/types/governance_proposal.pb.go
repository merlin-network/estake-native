...
// source: estake/lscosmos/v1beta1/governance_proposal.proto
...
type MinDepositAndFeeChangeProposal struct {
	...
	EstakeDepositFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=estake_deposit_fee,json=estakeDepositFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_deposit_fee"`
	EstakeRestakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=estake_restake_fee,json=estakeRestakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_restake_fee"`
	EstakeUnstakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,6,opt,name=estake_unstake_fee,json=estakeUnstakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_unstake_fee"`
	EstakeRedemptionFee github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,7,opt,name=estake_redemption_fee,json=estakeRedemptionFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"estake_redemption_fee"`
}
...
type EstakeFeeAddressChangeProposal struct {
	Title            string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description      string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	EstakeFeeAddress string `protobuf:"bytes,3,opt,name=estake_fee_address,json=estakeFeeAddress,proto3" json:"estake_fee_address,omitempty"`
}

func (m *EstakeFeeAddressChangeProposal) Reset()      { *m = EstakeFeeAddressChangeProposal{} }
func (*EstakeFeeAddressChangeProposal) ProtoMessage() {}
func (*EstakeFeeAddressChangeProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_47404a6acaa6ce8f, []int{1}
}
func (m *EstakeFeeAddressChangeProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EstakeFeeAddressChangeProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EstakeFeeAddressChangeProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EstakeFeeAddressChangeProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EstakeFeeAddressChangeProposal.Merge(m, src)
}
func (m *EstakeFeeAddressChangeProposal) XXX_Size() int {
	return m.Size()
}
func (m *EstakeFeeAddressChangeProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_EstakeFeeAddressChangeProposal.DiscardUnknown(m)
}

var xxx_messageInfo_EstakeFeeAddressChangeProposal proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*MinDepositAndFeeChangeProposal)(nil), "estake.lscosmos.v1beta1.MinDepositAndFeeChangeProposal")
	proto.RegisterType((*EstakeFeeAddressChangeProposal)(nil), "estake.lscosmos.v1beta1.EstakeFeeAddressChangeProposal")
	proto.RegisterType((*AllowListedValidatorSetChangeProposal)(nil), "estake.lscosmos.v1beta1.AllowListedValidatorSetChangeProposal")
}

func init() {
	proto.RegisterFile("estake/lscosmos/v1beta1/governance_proposal.proto", fileDescriptor_47404a6acaa6ce8f)
}
...
func (m *EstakeFeeAddressChangeProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EstakeFeeAddressChangeProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EstakeFeeAddressChangeProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EstakeFeeAddress) > 0 {
		...
		i = encodeVarintGovernanceProposal(dAtA, i, uint64(len(m.EstakeFeeAddress)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Description) > 0 {
...
func (m *EstakeFeeAddressChangeProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EstakeFeeAddressChangeProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EstakeFeeAddressChangeProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EstakeFeeAddressChangeProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
